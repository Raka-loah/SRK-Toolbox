...
module.exports = {
    ...
    // testOp(browser, "CBOR Encode", "test input", "test output");
        testOp(browser, "CRC校验和", "test input", "77c7", ["CRC-16"]);
        testOp(browser, "CRC校验和", "test input", "29822bc8", ["CRC-32"]);
        testOp(browser, "CRC校验和", "test input", "9d", ["CRC-8"]);
    ...
    // testOp(browser, "Parse ASN.1 hex string", "test input", "test_output");
        ...
        testOpHtml(browser, "解析IPv4标头", "45 c0 00 c4 02 89 00 00 ff 11　1e 8c c0 a8 0c 01 c0 a8 0c 02", "tr:last-child td:last-child", "192.168.12.2");
